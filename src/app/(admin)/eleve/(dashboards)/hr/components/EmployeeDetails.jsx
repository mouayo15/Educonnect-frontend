...
const EmployeDetails = () => {
  return <div className="col-span-1">
      <div className="grid md:grid-cols-2 grid-cols-1 gap-5">
        <EmployeeCard title="Cours suivis / réservations" value={615} percentage="15%" percentageType="success" chartOptions={getTotalEmployee} />

        <EmployeeCard title="Objectif de cours mensuel" value={174} percentage="26%" percentageType="success" chartOptions={getTotalApplication} />

        <EmployeeCard title="Crédits disponibles" value={64} percentage="0.5%" percentageType="danger" chartOptions={getHiredCandidates} />

        <EmployeeCard title="Taux d’activité" value={110} percentage="16%" percentageType="danger" chartOptions={getRjectedCandidates} />
      </div>
    </div>;
};
